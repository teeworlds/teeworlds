...
function BuildContent(settings, arch, conf)
	...
	if family == "windows" then
		...
		AddJob({"other/sdl/include/SDL.h", "other/sdl/windows/lib64/SDL2.dll"}, "Downloading SDL2", dl .. " sdl")
		AddJob({"other/freetype/include/ft2build.h", "other/freetype/windows/lib64/freetype.dll"}, "Downloading freetype", dl .. " freetype")
