...
MACRO_CONFIG_INT(SvExtConPort, sv_ext_con_port, 0, 0, 65535, CFGFLAG_SERVER, "0 = off")
MACRO_CONFIG_STR(SvExtConAddr, sv_ext_con_addr, 16, "0.0.0.0", CFGFLAG_SERVER, "0.0.0.0 = any")
