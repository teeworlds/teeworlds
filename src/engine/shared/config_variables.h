...
MACRO_CONFIG_STR(SvEconAddr, sv_econ_addr, 16, "0.0.0.0", CFGFLAG_SERVER, "Local address to bind econ listener to (0.0.0.0 = any)")
MACRO_CONFIG_INT(SvEconPort, sv_econ_port, 0, 0, 65535, CFGFLAG_SERVER, "Local TCP port to listen on (0 = do not listen at all)")
