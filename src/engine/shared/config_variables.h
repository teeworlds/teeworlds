...
MACRO_CONFIG_INT(SvAutoShoot, sv_autoshoot, 0, 0, 1, CFGFLAG_SERVER, "Autoshoot", 3)
MACRO_CONFIG_INT(SvSpecCantVote, sv_speccantvote, 0, 0, 1, CFGFLAG_SERVER, "If spec can vote or not ( 1 for yes )", 3)
