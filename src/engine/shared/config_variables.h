...
MACRO_CONFIG_INT(BrMaxRequests, br_max_requests, 150, 0, 1000, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Number of requests to use when refreshing server browser", -1)
...
MACRO_CONFIG_INT(SvSlashEmote, sv_slash_emote, 1, 0, 1, CFGFLAG_SERVER, "weather people can do /emote or not", 3)
