...
MACRO_CONFIG_INT(ClRaceGimmicks, cl_race_gimmicks, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Show race gimmicks (e.g. flags, special grenade launchers, crosshairs)")
...
MACRO_CONFIG_INT(ClRaceGimmicksLauncher, cl_race_gimmicks_launcher, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Show race gold/silver/bronze grenade launcher")
