...
enum
{
	...
	MAX_NAME_LENGTH=16,
	MAX_NAME_ARRAY_SIZE=MAX_NAME_LENGTH*UTF8_BYTE_LENGTH,
	MAX_CLAN_LENGTH=12,
	MAX_CLAN_ARRAY_SIZE=MAX_CLAN_LENGTH*UTF8_BYTE_LENGTH,
	MAX_SKIN_LENGTH=24,
	MAX_SKIN_ARRAY_SIZE=MAX_SKIN_LENGTH*UTF8_BYTE_LENGTH,
