...
IPickupWeapon::IPickupWeapon(CGameWorld *pGameworld, int weaponType)
...
int
IPickupWeapon::OnPickup(CCharacter *pChr)
{
...
CPickupGrenade::CPickupGrenade(CGameWorld *pGameworld) : IPickupWeapon(pGameworld,WEAPON_GRENADE)
{
}

CPickupShotgun::CPickupShotgun(CGameWorld *pGameworld) : IPickupWeapon(pGameworld,WEAPON_SHOTGUN)
{
}

CPickupLaser::CPickupLaser(CGameWorld *pGameworld) : IPickupWeapon(pGameworld,WEAPON_RIFLE)
{
}
