...
MACRO_CONFIG_INT(SvMatchesPerMap, sv_matches_per_map, 5, 1, 100, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of matches on each map before rotating") // INFCROYA RELATED
MACRO_CONFIG_INT(SvMatchSwap, sv_match_swap, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_SERVER, "Swap teams between matches")
MACRO_CONFIG_INT(SvPowerups, sv_powerups, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_SERVER, "Allow powerups like ninja") // INFCROYA RELATED
MACRO_CONFIG_INT(SvScorelimit, sv_scorelimit, 0, 0, 1000, CFGFLAG_SAVE|CFGFLAG_SERVER, "Score limit (0 disables)") // INFCROYA RELATED
MACRO_CONFIG_INT(SvTimelimit, sv_timelimit, 5, 0, 1000, CFGFLAG_SAVE|CFGFLAG_SERVER, "Time limit in minutes (0 disables)") // INFCROYA RELATED
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "mod", CFGFLAG_SAVE|CFGFLAG_SERVER, "Game type (dm, tdm, ctf, lms, lts)") // INFCROYA RELATED
...
MACRO_CONFIG_INT(SvPlayerSlots, sv_player_slots, 8, 0, MAX_CLIENTS, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of slots to reserve for players") // INFCROYA RELATED
