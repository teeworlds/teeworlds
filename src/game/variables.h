...
MACRO_CONFIG_INT(ClCustomizeSkin, cl_customize_skin, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Customize skin")
...
MACRO_CONFIG_INT(PlayerRedColorBody, player_red_color_body, 0, -32, 32, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player body red team color")
MACRO_CONFIG_INT(PlayerRedColorTattoo, player_red_color_tattoo, 0, -32, 32, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player tattoo red team color")
MACRO_CONFIG_INT(PlayerRedColorDecoration, player_red_color_decoration, 0, -32, 32, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player decoration red team color")
MACRO_CONFIG_INT(PlayerRedColorHands, player_red_color_hands, 0, -32, 32, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player hands red team color")
MACRO_CONFIG_INT(PlayerRedColorFeet, player_red_color_feet, 0, -32, 32, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player feet red team color")
MACRO_CONFIG_INT(PlayerRedColorEyes, player_red_color_eyes, 0, -32, 32, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player eyes red team color")

MACRO_CONFIG_INT(PlayerBlueColorBody, player_blue_color_body, 155, 123, 187, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player body blue team color")
MACRO_CONFIG_INT(PlayerBlueColorTattoo, player_blue_color_tattoo, 155, 123, 187, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player tattoo blue team color")
MACRO_CONFIG_INT(PlayerBlueColorDecoration, player_blue_color_decoration, 155, 123, 187, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player decoration blue team color")
MACRO_CONFIG_INT(PlayerBlueColorHands, player_blue_color_hands, 155, 123, 187, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player hands blue team color")
MACRO_CONFIG_INT(PlayerBlueColorFeet, player_blue_color_feet, 155, 123, 187, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player feet blue team color")
MACRO_CONFIG_INT(PlayerBlueColorEyes, player_blue_color_eyes, 155, 123, 187, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player eyes blue team color")
