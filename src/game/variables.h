...
MACRO_CONFIG_STR(ClFontfile, cl_fontfile, 255, "data/fonts/vera.ttf", CFGFLAG_CLIENT|CFGFLAG_SAVE, "What font file to use")
...
MACRO_CONFIG_INT(ClRenderScore, cl_render_score, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Turnes the small score board on or off")
