...
MACRO_CONFIG_INT(SvLoadMapDefaults, sv_load_map_defaults, 1, 0, 2, CFGFLAG_SERVER, "Load map default settings (0=off, 1=from map, 2=from cfg or map in case cfg fails)")
