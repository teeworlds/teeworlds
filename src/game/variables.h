...
MACRO_CONFIG_INT(ClShowaim, cl_showaim, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show ingame Aim")
MACRO_CONFIG_INT(ClShowhud, cl_showhud, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Show ingame HUD")
MACRO_CONFIG_INT(ClFlathud, cl_flathud, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Flat HUD style")
MACRO_CONFIG_INT(ClShowbackground, cl_showbackground, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show ingame Background")
