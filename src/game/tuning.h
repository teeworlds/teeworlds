...
MACRO_TUNING_PARAM(IceControlAccel, ice_control_accel, 50.0f / TicksPerSecond)// make acceleration hard
MACRO_TUNING_PARAM(IceFriction, ice_friction, 0.95f) // same as air friction?
