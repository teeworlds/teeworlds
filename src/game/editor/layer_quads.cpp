...
CQuad *CLayerQuads::NewQuad()
{
	...
	int x = 0, y = 0;
	q->m_aPoints[0].x = f2fx(x);
	q->m_aPoints[0].y = f2fx(y);
	q->m_aPoints[1].x = f2fx(x+64);
	q->m_aPoints[1].y = f2fx(y);
	q->m_aPoints[2].x = f2fx(x);
	q->m_aPoints[2].y = f2fx(y+64);
	q->m_aPoints[3].x = f2fx(x+64);
	q->m_aPoints[3].y = f2fx(y+64);

	q->m_aPoints[4].x = f2fx(x+32); // pivot
	q->m_aPoints[4].y = f2fx(y+32);

	q->m_aTexcoords[0].x = f2fx(0);
	q->m_aTexcoords[0].y = f2fx(0);

	q->m_aTexcoords[1].x = f2fx(1);
	q->m_aTexcoords[1].y = f2fx(0);

	q->m_aTexcoords[2].x = f2fx(0);
	q->m_aTexcoords[2].y = f2fx(1);

	q->m_aTexcoords[3].x = f2fx(1);
	q->m_aTexcoords[3].y = f2fx(1);
