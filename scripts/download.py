...
def downloadAll(targets):
    ...
    url = "https://github.com/teeworlds/teeworlds-libs/archive/{}.zip".format(
        version)
...
def main():
    ...
    p = argparse.ArgumentParser(
        description="Download freetype and SDL library and header files for Windows.")
    p.add_argument("targets", metavar="TARGET", nargs='+', choices=[
                   "sdl", "freetype"], help='Target to download. Valid choices are "sdl" and "freetype"')
    args = p.parse_args()
