...
set_levelicons = SpriteSet("levelicons", image_levelicons, 3, 2)
...
container.sprites.Add(Sprite("level_a_off", set_levelicons, 0,1,1,1))
container.sprites.Add(Sprite("level_b_on", set_levelicons, 1,0,1,1))
container.sprites.Add(Sprite("level_b_off", set_levelicons, 1,1,1,1))
container.sprites.Add(Sprite("level_c_on", set_levelicons, 2,0,1,1))
container.sprites.Add(Sprite("level_c_off", set_levelicons, 2,1,1,1))
