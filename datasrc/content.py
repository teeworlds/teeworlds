...
image_demoslice = Image("demoslice", "ui/demo_slice.png")
...
container.images.Add(image_demoslice)
...
set_demoslice = SpriteSet("demoslice", image_demoslice, 3, 1)
...
container.spritesets.Add(set_demoslice)
...
container.sprites.Add(Sprite("demobutton_slice_begin", set_demoslice, 0,0,1,1))
container.sprites.Add(Sprite("demobutton_slice_end", set_demoslice, 1,0,1,1))
