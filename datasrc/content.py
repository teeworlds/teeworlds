...
image_clienticons = Image("clienticons", "client_icons.png")
...
container.images.Add(image_clienticons)
...
set_clienticons = SpriteSet("clienticons", image_clienticons, 2, 1)
...
container.spritesets.Add(set_clienticons)
...
container.sprites.Add(Sprite("gamer", set_clienticons, 0, 0, 1, 1))
container.sprites.Add(Sprite("zilly", set_clienticons, 1, 0, 1, 1))
